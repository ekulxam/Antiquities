...
public class BoggedHeadEntityModel extends SkullBlockEntityModel {
	private final ModelPart head;

	public BoggedHeadEntityModel(ModelPart root) {
		super(root);
		this.head = root.getChild(EntityModelPartNames.HEAD);
	}

	public static ModelData getModelData() {
		return BoggedEntityModel.getModelData(Dilation.NONE, 0);
	}
