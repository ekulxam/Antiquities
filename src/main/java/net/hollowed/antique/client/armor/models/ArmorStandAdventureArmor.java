...
public class ArmorStandAdventureArmor extends BipedEntityModel<ArmorStandEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData rightArmThick = modelPartData.addChild("rightArmThick", ModelPartBuilder.create().uv(14, 54).cuboid(-2.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.8F))
		...
		ModelPartData leftArmThick = modelPartData.addChild("leftArmThick", ModelPartBuilder.create().uv(46, 0).cuboid(-2.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.26F))
